 ...
 * baixo acoplamento é desejável, pois significa que as classes estão bem isoladas 
 * e independentes.
 * 
 * exemplo:
 * uma classe pedido que depende diretamente de uma classe cliente (e não de uma interface) tem
